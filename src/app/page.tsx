...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24 bg-page-background text-page-text">
      ...
      <div className="mt-8">
        <Link href="/projects" className="inline-block bg-accent text-white font-bold py-3 px-8 rounded-full shadow-lg hover:bg-opacity-90 transition-all duration-300">
            Explore My Projects
        </Link>
      </div>
    </main>
